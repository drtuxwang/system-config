...
# Chinese
    ...
    button .mainmenu.rthk -width 10 -bg "#ffff00" -text "RTHK Radios" -command {exec firefox http://programme.rthk.hk/channel/radio/player_popup.php?rid=168&player=mp3&type=live &}
