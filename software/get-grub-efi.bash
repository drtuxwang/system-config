...
app_settings() {
    ...
    APP_FILES="
        ...
        $REPO/main/s/shim-helpers-amd64-signed/shim-helpers-amd64-signed_1+16.1+2~deb13u1_amd64.deb
        $REPO/main/s/shim-signed/shim-signed_1.51~1+deb13u1+16.1-2~deb13u1_amd64.deb
        ${0%/*}/files/grub.cfg
...
app_settings_arm() {
    ...
    APP_FILES="
        ...
        $REPO/main/s/shim-helpers-arm64-signed/shim-helpers-arm64-signed_1+16.1+2~deb12u1_arm64.deb
        $REPO/main/s/shim-signed/shim-signed_1.51~1+deb12u1+16.1-2~deb12u1_arm64.deb
