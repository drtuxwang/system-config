...
app_settings() {
    ...
    APP_SHELL="
        ...
        cp ${0%.*}/grub-pc.bash .
        touch -r grub-pc/grub-install README-grub-pc.md grub-pc.bash grub-pc/grub.cfg
        export XZ_OPT='-9 -e --x86 --lzma2=dict=128MiB --threads=1'
        tar cfJ - grub-pc --owner=0:0 --group=0:0 >> grub-pc.bash
        touch -r grub-pc/grub-install grub-pc.bash
    "
    APP_REMOVE="
        etc/
        grub-pc/
